        ...
        <footer className="site-footer">
            <div className="site-footer__inner">
                ...
                <div className="site-footer__right">
                    <span>
                        Based on{' '}
                        <a href="https://archivist.ramx.in/" target="_blank" rel="noopener noreferrer" className="site-footer__link">
                            Archivist
                        </a>
                        {' '}by{' '}
                        <a href="https://x.com/ramxcodes" target="_blank" rel="noopener noreferrer" className="site-footer__link">
                            @ramxcodes
                        </a>
                    </span>
                    <span className="site-footer__sep">·</span>
                    <a
                        ...
                        className="site-footer__link site-footer__github"
                        title="GitHub"
                    >
